...
function update(dt)
  if not storage.dungeonIdSet then
    -- world must be protected *after* initial dungeon placement has completed
    world.setTileProtection(65535, true)
    storage.dungeonIdSet = true
  end
